...
#define STRING_CONFIG_H_AUTHOR "(LulzBot AO100, firmware cargado por : Javi- darkjavi@gmail.com)" // Who made the changes.
...
#define DEFAULT_MAX_FEEDRATE          {800, 800, 5, 50}    // (mm/sec)
